...
public class W2H {
    ...
    public static void main(String[] args) {
        try {
            wordToHtml("d:\\全球经济简报（2017年11月3日).docx", "d:\\", "123.html");
//            wordToHtml("d:\\buglist.doc", "d:\\", "12.html");
...
//          writeFile(new String("<html><head>  <meta http-equiv=\"content-type\" content=\"text/html\" charset=\"utf-8\"/></head>对不起，.docx格式的word文档，暂时不能生成预览</html>".getBytes("utf-8")), outPutFilePath+newFileName);
            ...
            serializer.setOutputProperty(OutputKeys.METHOD, "src/main/webapp/html");
    ...
    public static void convert2HtmlDocxOnly(InputStream inputStream, String outPutFilePath, String newFileName)
            throws TransformerException, IOException,
            ParserConfigurationException {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        XWPFDocument document = new XWPFDocument(inputStream);
