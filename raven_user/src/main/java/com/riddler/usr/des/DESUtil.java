...
//    public final static String SECRET_KEY  = "41981651";

    public static void main(String[] args) throws Exception {
        long time=System.currentTimeMillis();
//        System.out.println(time);
//        String ss=encryption("17612105202-"+time,SECRET_KEY);
//        String ss=encryption("helloworld",SECRET_KEY);
//        System.out.println(ss);
        System.out.println(decryption("dOFlnBdkEaNbCIFmfRcJsQ==","12345678"));
    }
